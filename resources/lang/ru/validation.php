...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение поля :attribute обнаружено в утёкших данных. Пожалуйста, выберите другое значение.',
    ],
    ...
    */
    ...
    'custom' => [
        'name' => [
            'regex' => 'Поле "Имя" может содержать только латинские символы, цифры и символы _ - .',
        ],
    ],
